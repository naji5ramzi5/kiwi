-- ==========================================
-- FIX: Branch POS Tables RLS Policies
-- ==========================================
-- Execute this AFTER fix_inventory_rls.sql
...
-- Allow all users to read/write branch_inventory
...
-- Allow all users to read/write purchases
CREATE POLICY "purchases_insert"
  ON public.purchases FOR ALL
  USING (true) WITH CHECK (true);

-- Allow all users to read/write purchase items
CREATE POLICY "purchase_items_insert"
  ON public.purchase_items FOR ALL
  USING (true) WITH CHECK (true);

-- Allow all users to read/write daily settlements
...
-- Link Products to Branch Inventory (Zero Quantity initially)
