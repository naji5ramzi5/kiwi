...
class NotificationService {
  ...
  static const String channelId = 'kiwi_operations_notifications';
  static const String channelName = 'Kiwi Operations Alerts';
    ...
    if (androidPlugin != null) {
      await androidPlugin.createNotificationChannel(
        const AndroidNotificationChannel(
          channelId,
          channelName,
          description: 'Kiwi operations monitoring alerts',
  ...
  static Future<String?> _downloadImage(String url) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final file = File(
          '${dir.path}/ops_notification_${DateTime.now().millisecondsSinceEpoch}.jpg',
        );
