...
const NAV = [
  ...
  { label: 'الطلبات الموصلة', path: '/delivered-orders', icon: PackageCheck, section: 'خدمات التوصيل', color: '#10b981' },
  { label: 'تقرير موظفي التوصيل', path: '/delivery-employees-report', icon: FileText, section: 'خدمات التوصيل', color: '#10b981' },
...
const PAGE_TITLES: Record<string, string> = {
  ...
  '/delivered-orders': { parent: 'خدمات التوصيل', parentPath: '/delivered-orders', current: 'الطلبات الموصلة' },
  '/delivery-employees-report': { parent: 'خدمات التوصيل', parentPath: '/delivered-orders', current: 'تقرير موظفي التوصيل' },
  '/delivered-orders': 'الطلبات الموصلة',
  '/delivery-employees-report': 'تقرير موظفي التوصيل',
      ...
      <aside className="sidebar">
        <div className="sidebar-brand">
          <div className="brand-logo">
            <div style={{ width: 40, height: 40, borderRadius: 8, overflow: 'hidden', boxShadow: '0 4px 12px rgba(16,185,129,.3)' }}>
              <img src="/kiwi-logo.jpg" alt="Kiwi" style={{ width: 40, height: 40, objectFit: 'cover', borderRadius: 8 }} />
            </div>
            <div>
